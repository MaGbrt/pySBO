...
#--------------------------------------------------------#
#-------------abstract class Absorbent_Walls-------------#
#--------------------------------------------------------#
class Absorbent_Walls(Positions_Updater):
    """Class for positions updater with absorbent walls."""
    ...
    #-------------__str__-------------#
    def __str__(self):
        return "Positions updater with absorbent walls"
    ...
    def perform_positions_update(self, swarm):
        ...
        swarm.velocities[idx_dim_1, idx_dim_2]=0
        # upper bound
